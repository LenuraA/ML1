...
1.  Берем по 250 элементов в каждом классе, ковариационные матрицы равны, следовательно разделяющая линия вырождается в прямую:
![screenshot of sample](https://github.com/ZaraL3/ML1/blob/master/image/Pl1.png)

2. Берем по  300 элементов в каждом классе. Видим, что эллипсоиды параллельны осям координат: Ковариационные матрицы:
```R
Sigma1 <- matrix(c(10, 0, 0, 1), 2, 2)
Sigma2 <- matrix(c(3, 0, 0, 3), 2, 2)
```
![screenshot of sample](https://github.com/ZaraL3/ML1/blob/master/image/Pl2.png)

3. Здесь берем по 70 эелементов каждом классе. Ковариационные матрицы не равны, разделяющая плотность является квадратичной и прогибается таким образом, что менее плотный класс охватывает более плотный.
Ковариационные матрицы:
```R
Sigma1 <- matrix(c(3, 0, 0, 1), 2, 2)
Sigma2 <- matrix(c(10, 0, 0, 15), 2, 2)
```
![screenshot of sample](https://github.com/ZaraL3/ML1/blob/master/image/Pl3.png)

Дискриминатная функция: гипербола:

![screenshot of sample](https://github.com/ZaraL3/ML1/blob/master/image/Pl4.png)
